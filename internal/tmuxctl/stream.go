...
func shouldIgnoreLine(line string) bool {
	...
	case strings.HasPrefix(line, "╭"),
		...
		strings.HasPrefix(line, "Token usage:"),
		strings.HasPrefix(line, "To continue this session, run codex resume"),
		strings.HasPrefix(line, "⚠ Model metadata for "),
		strings.HasPrefix(line, "can degrade performance and cause issues."),
		strings.HasPrefix(line, "User attached "),
