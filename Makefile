...
test:
	...
	$(GO) test ./internal/gateway -run 'Test(RouterStartBeginsMonitoringExistingConfiguredGroups|Service(DoesNotReplayPreviousHistoryOnNewRequest|DoesNotReplayLateResumeBackfillBeforeBusy|DoesNotReplayLateForeignTailAfterRestartBeforeCurrentRunStarts|ForwardsFastReplyWhenNoBusySnapshotIsObserved|DoesNotForwardMultilinePromptEchoTail|DoesNotForwardWrappedSingleLinePromptEchoTail|EditableMessengerKeepsWorkingMessageSeparateFromReply|PollSkipsUnarmedOutputUntilFirstDispatch|FlushesBufferedReplyBeforeDispatchingNextMessage|SendsChatActionWhileWaitingForFirstVisibleReply|KeepsRunInFlightAcrossCaptureFailureWithoutOutputYet|RecoversSessionAfterCaptureFailureEvenWithoutBufferedDelta|StartMonitoringExistingSessionSkipsBaselineAndForwardsNewTail|PollDropsPassiveRecoveryResetInsteadOfReplaying|PollDropsOversizedPassiveRecoveryWindowWithoutRunDrop|DoesNotDispatchPendingDuringSilentRunBeforeGraceExpires|DispatchesPendingAfterSilentRunGraceExpires|InterruptsRunningCodexBeforeDispatchingLatestMessage|KeepsOnlyLatestPendingMessageWhileSessionStartsWhenInterruptEnabled|PreservesStartupMessageOrderWhenInterruptDisabled))' -count=1
